...
from django_gems.jewelry.models import (
    Category, GoldCaratWeight, Metal, Size, StoneColor, StoneType,
    Jewelry, JewelryMetal, JewelryStone, JewelrySize
)
from django_gems.core.get_all_objects import (
    categories, jewelries, metals,
    gold_carats, stone_types, stone_colors, sizes
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.bulk_create_metal()
        self.bulk_create_gold_carat_weight()
        self.bulk_create_stone_title()
        self.bulk_create_stone_color()
        self.bulk_create_size()
        self.bulk_create_jewelry()
        self.bulk_create_jewelry_by_metal()
        self.bulk_create_jewelry_by_stone()
        self.bulk_create_jewelry_by_size()
    ...
    def bulk_create_metal(self):
        Metal.objects.bulk_create([
            Metal(title='YG'),
            Metal(title="RG"),
            Metal(title="WG"),
            Metal(title='PT')
    ...
    def bulk_create_gold_carat_weight(self):
        GoldCaratWeight.objects.bulk_create([
    ...
    def bulk_create_stone_title(self):
        StoneType.objects.bulk_create([
            StoneType(title="BS"),
            StoneType(title="DI"),
            StoneType(title="EM"),
            StoneType(title="RU"),
    ...
    def bulk_create_stone_color(self):
        StoneColor.objects.bulk_create([
            StoneColor(title='AQ'),
            StoneColor(title='BL'),
            StoneColor(title='BU'),
            StoneColor(title='GR'),
    ...
    def bulk_create_jewelry(self):
        Jewelry.objects.bulk_create([
            Jewelry(
    ...
    def bulk_create_jewelry_by_metal(self):
        JewelryMetal.objects.bulk_create([
            JewelryMetal(
                jewelry=jewelries[0],
                metal=metals[3],
            ),
    ...
    def bulk_create_jewelry_by_stone(self):
        JewelryStone.objects.bulk_create([
            JewelryStone(
                jewelry=jewelries[0],
    ...
    def bulk_create_jewelry_by_size(self):
        JewelrySize.objects.bulk_create([
            JewelrySize(
                jewelry=jewelries[0],
                size=sizes[8],
            ),
