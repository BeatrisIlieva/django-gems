    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('B', 'Bracelet'), ('E', 'Earring'), ('N', 'Necklace'), ('R', 'Ring')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(choices=[('BS', 'Spinel'), ('DI', 'Diamond'), ('EM', 'Emerald'), ('RU', 'Ruby'), ('SA', 'Sapphire')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Size',
